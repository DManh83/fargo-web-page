export default {
  services: {
    ...
    seaFreight: {
      ...
      overviewDescription: `Vận chuyển biển vẫn là phương pháp kinh tế và đáng tin cậy nhất để vận chuyển lượng lớn hàng hóa qua thị trường quốc tế. Fargo Logistics cung cấp cả dịch vụ FCL (Tải trọng đầy container) và LCL (Tải trọng nhỏ hơn container) với lịch trình linh hoạt và tỷ giá cạnh tranh. Với mạng lưới đối tác mạnh mẽ với các hãng vận chuyển lớn, chúng tôi đảm bảo hoạt động mượt mà, an toàn và đúng hạn cho tất cả các lô hàng.`,
      ...
      flexibleOptions: 'Tùy chọn linh hoạt',
      flexibleOptionsDescription: `Chúng tôi cung cấp cả dịch vụ FCL (Tải trọng đầy container) và LCL (Tải trọng nhỏ hơn container), cung cấp sự lựa chọn vận chuyển linh hoạt và cẩn thận được thiết kế phù hợp với các kích thước hàng hóa và nhu cầu kinh doanh cụ thể.`,
