export default {
  services: {
    ...
    logisticsAndSupplyChain: {
      ...
      globalNetworkDescription: `Có biển xưa và đối tác quốc tế rộng lớn, chúng tôi đảm bảo hoạt động chuyển tiếp qua biên giới mượt mà, cung cấp cho khách hàng quyền truy cập vào hệ thống logistics toàn diện.`,
    ...
    seaFreight: {
      ...
      wideGlobalNetworkDescription: `Trực tiếp truy cập các cảng quốc tế lớn với mạng lưới đối tác quốc tế mạnh mẽ đảm bảo các tuyến vận chuyển đáng tin cậy và kết nối mượt mà qua tất cả các tuyến thương mại quốc tế lớn.`,
      costSavings: 'Tiết kiệm chi phí',
      ...
      flexibleOptions: 'Tùy chọn linh hoạt',
      flexibleOptionsDescription: `Chúng tôi cung cấp cả dịch vụ FCL (nguyên container) và LCL (ghép container), cung cấp sự lựa chọn vận chuyển linh hoạt và cẩn thận được thiết kế phù hợp với các kích thước hàng hóa và nhu cầu kinh doanh cụ thể.`,
